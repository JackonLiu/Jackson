...
/*");
    ...
    private void doShareToQQ(final Bundle params) {
        ...
        ThreadManager.getMainHandler().post(new Runnable() {
            ...
            @Override
            public void run() {
                if (null != AddLost.mTencent) {
                    AddLost.mTencent.shareToQQ(QQShareActivity.this, params, qqShareListener);
                }
            }
        });
    }
    ...
    protected void onDestroy() {
        super.onDestroy();
        if (AddLost.mTencent != null) {
            AddLost.mTencent.releaseResource();
        }
    }
